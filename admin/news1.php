...
echo"<BODY onLoad=\"javascript: alert('News Edited!')\">
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="1" width="800" bgcolor="#171717">
    ...
    <tr>
      ...
      <td width="20%" bgcolor="#363F5A">
        <p style="margin-left: 10"><b><font face="Verdana" size="2" color="#FFFFFF">EDIT NEWS # <? print $id; ?></font></b></td>
...
<form name="dfl" action="news1.php" method="post">
...
<table width="90%">
    <tr>
      ...
      <td width="80%" bgcolor="#0E1016" align="left">
        <p style="margin-left: 10"><input type="text" name="title" size="70" style="font-family: Verdana; font-size: 8pt; font-weight: bold; background-color: #000000; color: #C0C0C0; border-style: solid; border-color: #141721" value="<? print "$title"; ?>"></td>
    </tr>
    <tr>
      <td width="20%" bgcolor="#141721" align="left">
        <p style="margin-left: 10"><b><font face="Verdana" size="2">Author</font></b></td>
      <td width="80%" bgcolor="#141721" align="left">
        <p style="margin-left: 10"><font face="Verdana" size="2"><? print $author; ?></font></td>
    </tr>
    <tr>
      <td width="20%" bgcolor="#141721" align="left">
        <p style="margin-left: 10"><b><font face="Verdana" size="2">News</font></b></td>
	<td width="80%" bgcolor="#141721" align="left">
		<p style="margin-left: 10"><textarea name="news" rows="5" cols="70" style="FONT-WEIGHT: bold; FONT-SIZE: 8pt; BORDER-LEFT-COLOR: #141721; BORDER-BOTTOM-COLOR: #141721; COLOR: #c0c0c0; BORDER-TOP-STYLE: solid; BORDER-TOP-COLOR: #141721; FONT-FAMILY: Verdana; BORDER-RIGHT-STYLE: solid; BORDER-LEFT-STYLE: solid; BACKGROUND-COLOR: #000000; BORDER-RIGHT-COLOR: #141721; BORDER-BOTTOM-STYLE: solid"><? print "$news"; ?></textarea>
	</td>
	</tr>
    <tr>
      <td height="28" bgcolor="#141721" colspan="2">
        <p style="margin-left: 10" align="center"><font face="Verdana" size="2"><input style="color: #C0C0C0; background-color: #000000; font-family: Verdana; font-size: 8pt; font-weight: bold; border-style: solid; border-color: #141721" type="submit" value="Edit News"><input style="color: #C0C0C0; background-color: #000000; font-family: Verdana; font-size: 8pt; font-weight: bold; border-style: solid; border-color: #141721" type="reset" value="Reset"></font></td>
    </tr>
</table>
</center>
</form>
